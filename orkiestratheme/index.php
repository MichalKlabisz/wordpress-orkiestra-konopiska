            ...
            while(have_posts())
            {
                the_post(); ?>
                    ...
                    <div class="post">
                        ...
                        <h2 class="info"> <?php the_time('l, d/m/Y, G:i');  echo '| Autor: '; the_author_meta('user_firstname'); echo ' '; the_author_meta('user_lastname'); echo ' | '; comments_popup_link( 'Skomentuj', '1 komentarz', '% komentarzy', 'info', ''); echo ' | '; edit_post_link(); ?> </h2>
